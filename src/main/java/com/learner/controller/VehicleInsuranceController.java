...
public class VehicleInsuranceController {
    ...
    public ResponseEntity<String> StatusUpdation(@PathVariable("policyId") String policyNo,  @RequestParam("status") String status)
    {
        return ResponseEntity.ok(vehicleInsuranceService.statusApproval(policyNo, status));
    }
    ...
    public ResponseEntity<VehicleInsuranceDto> getPolicyByPolicyno(@PathVariable("policyNo") String policyNo)
    {

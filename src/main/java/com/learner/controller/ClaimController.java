...
public class ClaimController {
    ...
    public ResponseEntity<String> createClaim(@RequestParam("file") MultipartFile file,
        ...
        claimServices.saveClaims(email, policyName, policyId,policyNo,description, file);
        return ResponseEntity.ok("Thank You For Requesting Claim We Will Get Back To You Please Check Email for Future Updates............ ");
    }

...
public class HomeInsuranceController {
    ...
    @RequestParam("location")String location)throws IOException, SQLException
    {
       ...
       return ResponseEntity.ok(homeInsuranceService.ApplyHomeInsurance(documentimage, email, policyId,policyName, houseno, owner, location));
    }
    ...
    public ResponseEntity<HomeInsuranceDTO> getSpecificPolicy(@PathVariable("policyNo") String policyNo)
    {

...
public class TravelInsuranceServiceImpl{
    ...
    public TravelInsuranceDTO ApplyTravelInsurance(MultipartFile documentimage, String email, String policyId, String policyName, String destination,
        ...
        travelInsuranceDetails.setStatus(ti.getStatus());//
    ...
    {
    	TravelInsuranceDetails req = travelInsuranceRepository.findByPolicyNo(policyNo).get();

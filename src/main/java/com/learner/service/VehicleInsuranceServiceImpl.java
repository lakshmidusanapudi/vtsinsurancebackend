...
public class VehicleInsuranceServiceImpl{
    ...
    public String statusApproval(String policyNo, String status) {
        VehicleInsuranceDetails vehicleInsuranceDetails=vehicleInsuranceRepository.findByPolicyNo(policyNo).orElseThrow(
    ...
    public VehicleInsuranceDto getPolicyByPolicyno(String policyNo)
    {
    	VehicleInsuranceDetails req = vehicleInsuranceRepository.findByPolicyNo(policyNo).orElseThrow(
    			() -> new InsuranceRelavantException("Vehicle Insurance Details not found with "+policyNo)
    			);

...
public class HomeInsuranceServiceImpl{
    ...
    public HomeInsuranceDTO ApplyHomeInsurance(MultipartFile documentimage, String email, String policyId, String policyName, String houseno,
    ...
    {
    	HomeInsuranceDetails req = homeInsuranceRepository.findByPolicyNo(policyNo).get();

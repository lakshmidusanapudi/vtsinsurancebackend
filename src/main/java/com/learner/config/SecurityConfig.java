...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception
	{
		return http.csrf().disable().cors()
				...
				.requestMatchers("/user/register", "/user/login", "/otp/verify", "/otp/generate/**", "/otp/generate-register-otp/**")
				...
				.authenticated().and()
				.authorizeHttpRequests()
				.requestMatchers( "/claim/get-user-claims", "/claim/add-claim", "/claim/get-all-claims", "/claim/get-my-claims", "/claim/approve-claim/**", "/claim/cancel-claim/**")
				.authenticated().and()
				.authorizeHttpRequests()
				...
				.authenticated().and()
				.authorizeHttpRequests()
				.requestMatchers( "/feedback/save", "/feedback/get-all-feedbacks", "/feedback/delete-feedback/**", "/feedback/get-feedback-by-id/**")
				.permitAll().and()
				.authorizeHttpRequests()
